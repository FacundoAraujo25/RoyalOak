...
public class RoyalOakApplication {
	...
	public CommandLineRunner initData(ClienteRepositorio clienteRepositorio, ProductoRepositorio productoRepositorio, FacturaRepositorio facturaRepositorio, ClienteProductoPedidoRepositorio clienteProductoPedidoRepositorio){
		return (args) -> {
			...
			Producto producto1 = new Producto("Classic", "medallón_de_carne cheddar lechuga tomate cebolla morada Ali_oli", "https://drive.google.com/file/d/1GFaoNmz_a0XmEjLqMai1nJrM1K2swvyj/view?usp=sharing", 25, 550,Tipo.COMIDA, SubTipo.HAMBURGUESAS);
			Producto producto2 = new Producto("Baccon","Bacon dos_medallones_de_carne cheddar lechuga tomate cebolla morada mayonesa_casera","https://drive.google.com/file/d/1kApw5t-rMRLxDYwtFutbdD3Ff9qSViac/view?usp=sharing",20,650,Tipo.COMIDA, SubTipo.HAMBURGUESAS);
